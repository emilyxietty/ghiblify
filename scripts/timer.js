...
function startStudyTimer() {
  ...
  document.querySelector('.timer-container').style.backgroundImage = 'url("/icons/break/break1.png")';
  resetTimer();
}
...
function startBreakTimer() {
  ...
  document.querySelector('.timer-container').style.backgroundImage = 'url("/icons/break/break3.jpg")';
